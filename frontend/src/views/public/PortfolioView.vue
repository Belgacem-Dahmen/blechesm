        ...
        <div class="flex items-start justify-between gap-12">
          ...
          <div class="max-w-2xl">
            ...
            <div class="flex items-center gap-3 mb-6 hero-eyebrow">
              ...
              <svg width="56" height="24" viewBox="0 0 56 24" class="text-warning opacity-70 hidden sm:block" fill="none" aria-hidden="true">
            ...
            <h1 class="font-display text-5xl sm:text-6xl lg:text-7xl font-semibold tracking-tightest leading-[0.9] mb-6 hero-title">
              ...
              <span class="relative inline-block text-accent">
                ...
                <svg class="absolute -bottom-1 left-0 w-full" height="8" viewBox="0 0 320 8" preserveAspectRatio="none" fill="none" aria-hidden="true">
                  <path d="M0,4 Q40,0 80,4 Q120,8 160,4 Q200,0 240,4 Q280,8 320,4" stroke="#FF6B35" stroke-width="3.5" stroke-linecap="round" opacity="0.65"/>
                </svg>
              </span>
            </h1>
            ...
            <p class="text-text-2 text-lg leading-relaxed mb-10 max-w-xl hero-sub">
              ...
              découvrez l'étendue de notre travail à travers toute la France.
            </p>
          ...
          <div class="hidden lg:flex flex-col items-end gap-3 pt-12 hero-stickers shrink-0">
            ...
            <svg width="28" height="64" viewBox="0 0 28 64" class="text-text-3 opacity-50 mb-1" fill="none" aria-hidden="true">
      ...
      <div class="absolute bottom-0 left-0 right-0 leading-[0] pointer-events-none">
        <svg viewBox="0 0 1440 36" preserveAspectRatio="none" class="w-full h-9" aria-hidden="true">
          <path d="M0,0 L1440,0 L1440,12
            Q1400,36 1360,12 Q1320,0 1280,20 Q1240,36 1200,16
            Q1160,0 1120,18 Q1080,36 1040,16
            Q1000,0 960,22 Q920,36 880,18
            Q840,4 800,24 Q760,36 720,20
            Q680,4 640,22 Q600,36 560,18
            Q520,2 480,20 Q440,36 400,16
            Q360,0 320,20 Q280,36 240,16
            Q200,0 160,22 Q120,36 80,18
            Q40,4 0,18 Z"
            fill="#080B14"
          />
        </svg>
        ...
        <div class="flex items-center gap-3 py-4 overflow-x-auto no-scrollbar">
          ...
          <div class="hidden sm:flex items-center gap-1.5 shrink-0 mr-1 text-text-3">
            <svg width="20" height="14" viewBox="0 0 20 14" fill="none" aria-hidden="true">
              ...
              <path d="M11,4 L15,7 L11,10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          ...
          >
            <span
              v-if="activeTag === tag"
              class="inline-block w-1.5 h-1.5 rounded-full mr-1.5 shrink-0"
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div v-if="filteredItems.length > 0" class="portfolio-grid">
        <article
          ...
          :class="i === 0 && activeTag === 'all' ? 'portfolio-card--featured' : ''"
          :style="{
...
const heroStats = [
  ...
  { value: '12+',   label: 'Villes en France',   color: '#22D3EE' },
]
...
.hero-title   { animation: fade-up 0.65s ease 0.15s both; }
.hero-sub     { animation: fade-up 0.55s ease 0.3s both; }
.hero-stats   { animation: fade-up 0.5s ease 0.42s both; }
.hero-stickers { animation: fade-left 0.7s ease 0.2s both; }
...
.sticker:hover { box-shadow: 0 0 18px rgba(0,0,0,0.4), inset 0 0 0 1px var(--sc); }
...
.portfolio-card:hover .card-topbar { height: 5px; }
...
.portfolio-card:hover .card-overlay-inner { transform: translateY(0); }
...
.portfolio-card--featured .ov-title { font-size: 24px; }
...
.portfolio-card--featured .ov-desc { -webkit-line-clamp: 3; }
...
/* ── CTA section ────────────────────────────────────────────────── */
.cta-content { animation: fade-up 0.6s ease both; }
...
@media (prefers-reduced-motion: reduce) {
  .portfolio-card,
  .hero-eyebrow, .hero-title, .hero-sub, .hero-stats, .hero-stickers,
  .sticker, .cta-content { animation: none; }
  .card-img,
  .card-overlay, .card-overlay-inner, .ov-arrow,
  .card-topbar, .portfolio-card { transition: none; }
}
</style>
